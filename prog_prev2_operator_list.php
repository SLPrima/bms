...
?>
	...
	<tr>
	 <td>
		...
		$listeditpage = "prog_prev2_operator_edit.php";
		$listactionpage = "prog_prev2_operator_act.php";
		...
		$arcolcaption = array("TOWER","LANTAI","LOKASI","BARANG","JENIS","TGL.DIKERJAKAN","PERIODE","OPERATOR-1","OPERATOR-2","OPERATOR-3","STATUS","STATUS UNIT","LEADER","APV LEADER");
		$arcolname = array("gedung","lantai","lokasi","barang","jenis","tglkerja|date","periode","teknisi","teknisi2","teknisi3","status","statusunit","leader","apvleader");
		$arcolwidth = array("7%","7%","7%","7%","10%","10%","7%","7%","7%","7%","5%","7%","10%","7%");
		...
		$arfiltercolname = array("barang","gedung","lantai","lokasi","Jenis","teknisi","tglkerja");
  		...
  		$sql = "SELECT * from jadwal_prev2_ac where tglkerja <='$tgl' and apvleader = 'N' and (teknisi like '".$vusrnama.'%'."' or teknisi2 like '".$vusrnama.'%'."' or teknisi3 like '".$vusrnama.'%'."') and gedung like '".$vgedung.'%'."'";
