...
?>
	...
	<tr>
	 <td>
		...
		$listeditpage = "prog_prev2_edit.php";
		$listactionpage = "prog_prev2_act.php";
		...
		$arfiltercolcaption = array("Barang","Gedung","Lantai","Lokasi","Jenis","Operator-1","Leader","Tgl.Dikerjakan","APV Status");
		$arfiltercolname = array("barang","gedung","lantai","lokasi","Jenis","teknisi","leader","tglkerja","apvleader");
