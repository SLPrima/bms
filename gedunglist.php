...
<tr>
	<td>
		...
		$idcol = "gedung";
		$listtitle = "TABEL TOWER / GEDUNG";
    	$listmenupage = "main.php";
		$listeditpage = "gedungedit.php";
		$listactionpage = "gedungact.php";

  		$allow_delete= true;
  		$allow_logout= false;
		
		$arcolcaption = array("TOWER / GEDUNG");
		...
		$arfiltercolcaption = array("Tower/Gedung");
