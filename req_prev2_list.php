...
?>
	...
	<tr>
	 <td>
		...
		$listeditpage = "req_prev2_edit.php";
		$listactionpage = "req_prev2_act.php";
		...
		$arfiltercolcaption = array("Barang","Gedung","Lantai","Lokasi","Jenis","Operator-1",Leader,"Tgl.Dikerjakan");
		$arfiltercolname = array("barang","gedung","lantai","lokasi","jenis","Teknisi","leader","tglakhir");
 
    if ($vusrlevel == "1")
     {
  		$sql = "SELECT * from jadwal_prev2";
     } else {
