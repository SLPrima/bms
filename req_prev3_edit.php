...
<form name="frm" method="post" action="req_prev3_act.php" enctype="multipart/form-data" onSubmit="return validateForm();">

<table width="100%" cellpadding="0" cellspacing="0">
<tr>
	<td class="tablecoltitle" colspan="2" style = "background:darkblue; color:white">RAPIKAN SCHEDULE HOUSEKEEPING</td>
</tr>
</table>
