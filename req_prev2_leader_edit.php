...
<form name="frm" method="post" action="req_prev2_leader_act.php" enctype="multipart/form-data" onSubmit="return validateForm();">
...
<tr>
	...
	<td class="tablecoldetail" height="23">
	 <select name="txtLokasi" id="lokasi" >
		<option><?=$vlokasi?></option>
		<?php
			echo "<option value=\"Toilet Pria\">Toilet Pria</option>\n";
			echo "<option value=\"Toilet Wanita\">Toilet Wanita</option>\n";
			echo "<option value=\"Toilet Pria\">Toilet Pria dan Wanita</option>\n";
		?>
 	</select>
 </td>
</tr>
...
<tr>
	...
	<td class="tablecoldetail" height="23">
	 <select name="txtBarang" id="barang" >
...
<tr>
	...
	<td class="tablecoldetail" height="23">
	 <select name="txtJenis" id="jenis" >
		...
		<?php
			echo "<option value=\"Pemeliharaan Toilet\">Pemeliharaan Toilet</option>\n";
    	?>
 	</select>
 </td>
</tr>
...
<tr>
	...
	<td class="tablecoldetail" height="23">
	 <select name="txtTeknisi" id="teknisi" >
		...
		<?php
			$rs = $mainlib->dbquery("SELECT usernama,userid FROM Tbluser where level ='8' and gedung = '".$vgedung2[0]."' and leader <> '' order by usernama", $mainlib->ocn);
				echo "<option value=\"\"></option>\n";
 			while($p=$mainlib->dbfetcharray($rs))
			{
...
?>
  	...
  	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" style="cursor:pointer" value="  Back  " class="button" onClick="window.location='req_prev2_leader_list.php?pgret=1';">
