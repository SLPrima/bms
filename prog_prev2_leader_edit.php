...
<form name="frm" method="post" action="prog_prev2_leader_act.php" enctype="multipart/form-data" onSubmit="return validateForm();">
...
<tr>
	<td class="tablecolcaption" width="23%" style="color:blue">ITEM YANG DIBERSIHKAN</td>
	<td class="tablecoldetail" height="23">
...
<tr>
	<td class="tablecolcaption" width="23%" style="color:blue">TGL.SELESAI </td>
	<td class="tablecoldetail" height="23">
		<input type="text" name="txtTglselesai" class="inputtext2" style="padding-left:1px; maxlength="10" size="10" value="<?=$so_date?>" readonly>
		&nbsp;/&nbsp;
		<input type="text" name="txtJam" class="InputText" style="padding-left:1px; maxlength="7" size="7" value="<?=$vjam?>" readonly>
	</td>
</tr>
...
<tr>
 ...
 ?>    
  	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" style="cursor:pointer" value="    Back    " class="button" onClick="window.location='prog_prev2_leader_list.php?pgret=1';">
   </td>
</tr>
</table>
