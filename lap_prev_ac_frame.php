...
<form name="frm" method="post" action="lap_prev_ac.php" enctype="multipart/form-data" onSubmit="return validateForm();">
...
<tr>
	<td class="tablecolcaption" width="7%" style="color:blue">BARANG </td>
	<td class="tablecoldetail" height="23">
	  <input type="radio" name="barang[]" value="A" checked>AC <br />
	  <input type="radio" name="barang[]" value="B">Dispenser <br />
	  <input type="radio" name="barang[]" value="C">Apar <br />
	  <input type="radio" name="barang[]" value="D">Lift Elevator <br />
	  <input type="radio" name="barang[]" value="E">Genset <br />
	  <input type="radio" name="barang[]" value="F">Diesel Pump <br />
	  <input type="radio" name="barang[]" value="G">Pompa Boster <br />
	  <input type="radio" name="barang[]" value="H">Pompa Transfer <br />
	  <input type="radio" name="barang[]" value="I">Toilet <br />
	  <input type="radio" name="barang[]" value="J">Kelas <br />
	  <input type="radio" name="barang[]" value="K">Panel <br />
	</td>
</tr>
...
<tr>
	...
	<td class="tablecoldetail" height="23">
	  <input type="radio" name="status[]" value="1" checked>All &nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="radio" name="status[]" value="2">Progress &nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="radio" name="status[]" value="3">Pending &nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="radio" name="status[]" value="4">Done &nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="radio" name="status[]" value="5">Tidak Baik <br />
	</td>
</tr>
