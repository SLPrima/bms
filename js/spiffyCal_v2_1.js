...
img_Del.src= scImgPath +"spiffy_btn_del_small.gif";
img_Close.src= scImgPath +"spiffy_btn_close_small.gif";
...
function spiffyCalManager() {
	...
	this.Holidays = new Array("Dec-25");
	this.HolidaysDesc = new Array("Christmas Day");
...
function ctlSpiffyCalendarBox(strVarName, strFormName, strTextBoxName, strBtnName, strDefaultValue, intBtnMode) {
	...
	switch (intBtnMode) {
		case 0 :
			strBtnImg=strDefBtnImgPath+'spiffy_btn_date_up.gif';
			img_DateBtn_UP.src=strDefBtnImgPath+'spiffy_btn_date_up.gif';
			img_DateBtn_OVER.src=strDefBtnImgPath+'spiffy_btn_date_over.gif';
			img_DateBtn_DOWN.src=strDefBtnImgPath+'spiffy_btn_date_down.gif';
			img_DateBtn_DISABLED.src=strDefBtnImgPath+'spiffy_btn_date_disabled.gif';
			strBtnW = '18';
			strBtnH = '20';
			break;
		case 1 :
			strBtnImg=strDefBtnImgPath+'spiffy_btn_date1_up.gif';
			img_DateBtn_UP.src=strDefBtnImgPath+'spiffy_btn_date1_up.gif';
			img_DateBtn_OVER.src=strDefBtnImgPath+'spiffy_btn_date1_over.gif';
			img_DateBtn_DOWN.src=strDefBtnImgPath+'spiffy_btn_date1_down.gif';
			img_DateBtn_DISABLED.src=strDefBtnImgPath+'spiffy_btn_date1_disabled.gif';
			strBtnW = '22';
			strBtnH = '17';
			break;
		case 2 :
			strBtnImg=strDefBtnImgPath+'spiffy_btn_date2_up.gif';
			img_DateBtn_UP.src=strDefBtnImgPath+'spiffy_btn_date2_up.gif';
			img_DateBtn_OVER.src=strDefBtnImgPath+'spiffy_btn_date2_over.gif';
			img_DateBtn_DOWN.src=strDefBtnImgPath+'spiffy_btn_date2_down.gif';
			img_DateBtn_DISABLED.src=strDefBtnImgPath+'spiffy_btn_date2_disabled.gif';
			strBtnW = '34';
			strBtnH = '21';
			break;
	}
	...
	function makeCalendar(intWhatMonth,intWhatYear,bViewOnly) {
		...
		if (!(bViewOnly)) {
			...
			strOutput += '<\/SELECT>&nbsp;<a href="javascript:'+this.varName+'.scrollMonth(1);" class="cal-DayLink">&gt;</a>&nbsp;&nbsp;<a href="javascript:'+this.varName+'.hide();"><img name="calbtn2" src="'+strDefBtnImgPath+'spiffy_btn_close_small.gif" align="absmiddle" border="0" width="12" height="10"></a><\/td><\/tr><tr><td width="100%" align="center">';
		}
		else {
	...
	function writeControl() {
		...
		//strHold='<input class="cal-TextBox" type="text" name="' + this.textBoxName + '"' + strTemp + 'size="12" value="' + this.getSelectedDate() + '" readonly>';
		if (!scIE) {
