...
if (trim($id) != "")
{
	...
	if ($row = $mainlib->dbfetcharray($rs))
	{
		...
		$vr= $row["r"];
		$vampere= $row["ampere"];
		$vamperecomp= $row["amperecomp"];
		$vamperephase= $row["amperephase"];
	    ...
	    $vteganganpanel1b= $row["teganganpanel1b"];
	    $vteganganpanel1c= $row["teganganpanel1c"];
	    $vteganganpanel2= $row["teganganpanel2"];
	    $vteganganpanel2b= $row["teganganpanel2b"];
	    $vteganganpanel2c= $row["teganganpanel2c"];
	    $vmcbpanel= $row["mcbpanel"];
	    $vmcbamppanel= $row["mcbamppanel"];
	    $vmcbamppanel2= $row["mcbamppanel2"];
	    $vmcbamppanel3= $row["mcbamppanel3"];
...
var calTgl3 = new ctlSpiffyCalendarBox("calTgl3","frm","txtTglperbaikan","btnTgl3","",scBTNMODE_CALBTN);
...
<form name="frm" method="post" action="prog_prev_ac_act.php" enctype="multipart/form-data" onSubmit="return validateForm();">
...
<?php
 if ($vbarang == "AC" or $vbarang == "Apar" or $vbarang == "Genset"  or $vbarang == "Diesel Pump" or $vbarang == "Pompa Boster" or $vbarang == "Pompa Transfer" )
 {
...
<tr>
	<td class="tablecolcaption" width="23%" style="color:blue">TEKANAN REFIGRAN (R 410 / R 32)</td>
	<td class="tablecoldetail" height="23">
<?php
...
<?php
  if ($vusrlevel=="2" or $vusrlevel=="4")
  {
    if ($vusrlevel=="2")
     {
?>

  	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" style="cursor:pointer" value="  Back  " class="button" onClick="window.location='prog_prev_ac_list.php?pgret=1';">

<?php
     } 
    if ($vusrlevel=="4" and $vstatusunit == "Baik")
     {
?>

  	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="approve" style="cursor:pointer" value="  Approve  " class="button">
  	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" style="cursor:pointer" value="  Back  " class="button" onClick="window.location='prog_prev_ac_list.php?pgret=1';">
...
?>    
  	...
  	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="simpan" style="cursor:pointer" value="  Submit  " class="button">
  	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" style="cursor:pointer" value="  Back  " class="button" onClick="window.location='prog_prev_ac_list.php?pgret=1';">
